...
go install -p={{.NumCPU}} -x github.com/c-darwin/mobile/gl
go install -p={{.NumCPU}} -x github.com/c-darwin/mobile/app
go install -p={{.NumCPU}} -x github.com/c-darwin/mobile/exp/app/debug {{end}}
