...
package portable // import "github.com/c-darwin/mobile/exp/sprite/portable"

import (
	"image"
	"image/draw"

	xdraw "github.com/democratic-coin/dcoin-go/vendor/src/golang.org/x/image/draw"
	"github.com/democratic-coin/dcoin-go/vendor/src/golang.org/x/image/math/f64"
...
func affine(dst *image.RGBA, src image.Image, srcb image.Rectangle, mask image.Image, a *f32.Affine, op draw.Op) {
	...
	// to src-space. The github.com/democratic-coin/dcoin-go/vendor/src/golang.org/x/image/draw package's matrices transform
